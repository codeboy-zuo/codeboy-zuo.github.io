...
$.ajax({
    ...
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(115.81, 25.59, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
        ...
        你距离 <font color=red>左.</font> 约有<span>${dist}</span>公里<br><br>${posdesc}
        `;
        }
        showWelcome()
    }
