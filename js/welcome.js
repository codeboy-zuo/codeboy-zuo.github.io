...
$.ajax({
    ...
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(45.739565, 126.638539, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            switch (ipLoacation.result.ad_info.nation) {
                ...
                case "澳大利亚":
                    ...
                    break;
                case "越南":
                    posdesc = "Xin chào hân hạnh được gặp bạn";
                    break;
                case "加拿大":
                    posdesc = "拾起一片枫叶赠予你";
                    break;
        ...
        欢迎来自<span style="color: yellow;font-weight: bold">${pos}</span>的小伙伴，${timeChange}<br>
        你距离<span style="color: red;">左.</span>约有<span style="color: yellow;font-weight: bold">${dist}</span>公里
        <br>
        ${posdesc}
    </div>`;
        }
